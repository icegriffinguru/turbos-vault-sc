module turbos_vault::router {
    ...
    public entry fun close_vault<T0, T1>(
        arg0: &turbos_vault::config::GlobalConfig,
        arg1: &mut turbos_vault::vault::Strategy,
        arg2: turbos_vault::vault::Vault,
        arg3: &mut sui::tx_context::TxContext
    ) {
        turbos_vault::vault::close_vault<T0, T1>(arg0, arg1, arg2, arg3);
    }
    
    public entry fun collect_clmm_reward_direct_return<T0, T1, T2, T3>(
        arg0: &turbos_vault::config::GlobalConfig,
        arg1: &mut turbos_vault::vault::Strategy,
        arg2: &turbos_vault::vault::Vault,
    ...
    public entry fun collect_protocol_fee<T0>(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: u64,
        arg4: address,
    ...
    public entry fun collect_reward<T0>(
        arg0: &turbos_vault::config::GlobalConfig,
        arg1: &mut turbos_vault::rewarder::RewarderManager,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: &turbos_vault::vault::Vault,
        arg4: address,
    ...
    entry fun create_strategy<T0, T1, T2>(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
    ...
    public entry fun deposit<T0, T1, T2>(
        ...
        arg1: &mut turbos_vault::rewarder::RewarderManager,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: &mut turbos_vault::vault::Vault,
    ...
    public entry fun open_vault<T0, T1, T2>(
        arg0: &turbos_vault::config::GlobalConfig,
        arg1: &mut turbos_vault::vault::Strategy,
        ...
        arg12: u32,
        arg13: address,
        arg14: &mut sui::tx_context::TxContext
    ) {
    ...
    // deprecated
    // public entry fun rebalance<T0, T1, T2>(
    //     arg0: &turbos_vault::config::OperatorCap,
    //     arg1: &turbos_vault::config::GlobalConfig,
    //     arg2: &mut turbos_vault::rewarder::RewarderManager,
    ...
    public entry fun update_strategy_base_minimum_threshold(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: u32
    ...
    public entry fun update_strategy_limit_minimum_threshold(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: u32
    ...
    public entry fun update_strategy_status(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: u8
    ...
    public entry fun update_vault_base_rebalance_threshold(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: sui::object::ID,
    ...
    public entry fun update_vault_limit_rebalance_threshold(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: sui::object::ID,
    ...
    public entry fun update_vault_management_fee_rate(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: sui::object::ID,
    ...
    public entry fun update_vault_performance_fee_rate(
        arg0: &turbos_vault::config::OperatorCap,
        arg1: &turbos_vault::config::GlobalConfig,
        arg2: &mut turbos_vault::vault::Strategy,
        arg3: sui::object::ID,
    ...
    public entry fun open_vault_and_deposit<T0, T1, T2>(
        ...
        arg16: u32,
        arg17: address,
        arg18: &sui::clock::Clock,
        arg19: &turbos_clmm::pool::Versioned,
        arg20: &mut sui::tx_context::TxContext
    ) {
